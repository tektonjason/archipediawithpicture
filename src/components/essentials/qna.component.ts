  ...
  template: `
    <div class="ui-page text-white">
      ...
      <div class="ui-topbar">
        ...
        <div>
          <h2 class="text-xl font-bold">{{ displayText('问答 Q&A') }}</h2>
      ...
      <div class="flex-1 overflow-y-auto custom-scrollbar p-6 md:p-8">
        <div class="max-w-4xl mx-auto space-y-6">
            <div class="ui-empty-state py-20">
              ...
              <h3 class="text-lg font-bold text-gray-400 mb-2">{{ displayText('内容建设中') }}</h3>
              <p class="max-w-md">{{ displayText('本板块正在筹备中，将为您带来常见问题解答与经验分享，敬请期待。') }}</p>
            </div>
        </div>
      </div>
    </div>
