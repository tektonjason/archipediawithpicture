...
export class DataService {
  ...
  private seedArchipediaData() {
    ...
    const rawData: string[][] = [
      ...
      // 您可以在此处添加新[中国古代建筑]条目，格式如下：
      // ['中国古代建筑', '子分类', '条目名称', '英文名称', '定义', '详细描述'],
      ...
      // 您可以在此处添加新[西方古代建筑]条目，格式如下：
      // ['西方古代建筑', '子分类', '条目名称', '英文名称', '定义', '详细描述'],
      ...
      // 您可以在此处添加新[建筑风格与设计思潮]条目，格式如下：
      // ['建筑风格与设计思潮', '子分类', '条目名称', '英文名称', '定义', '详细描述'],
      ...
      // 您可以在此处添加新[城市规划与公共空间]条目，格式如下：
      // ['城市规划与公共空间', '子分类', '条目名称', '英文名称', '定义', '详细描述'],
      ...
      // 您可以在此处添加新[可持续与绿色建筑]条目，格式如下：
      // ['可持续与绿色建筑', '子分类', '条目名称', '英文名称', '定义', '详细描述'],
      ...
      // 您可以在此处添加新[结构与构造理论]条目，格式如下：
      // ['结构与构造理论', '子分类', '条目名称', '英文名称', '定义', '详细描述'],
    ...
    // 如果您添加了新分类（例如“未来建筑”）并希望它自动关联图片：
    // 1. 在 public/images/ 下创建文件夹（如 future_arch）
    // 2. 将图片按顺序命名（如 f1.webp, f2.webp...）
    // 3. 在下方添加配置：'未来建筑': { basePath: '/images/future_arch', prefix: 'f' }
