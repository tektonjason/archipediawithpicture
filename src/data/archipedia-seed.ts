...
export const ARCHIPEDIA_ROWS: ArchipediaRow[] = [
      ...
      ['建筑风格与设计思潮', '著名建筑师与理论', '流动空间', 'Flowing Space', '密斯提出的空间概念。', '打破房间的封闭感，使内部空间相互贯通并延伸至室外。'],
      ...
      ['建筑风格与设计思潮', '前卫', 'Archigram', 'Archigram', '建筑电讯派，英国60年代最先锋的创作倾向。', '夸张突出建筑技术符号，畅想“行走城市”，“插入式城市”等。'],
      ...
      // 中国当代建筑实践
      ['中国当代建筑实践', '现代建筑师/事务所', '王澍', 'Wang Shu', '中国当代建筑师，2012年普利兹克建筑奖获得者，业余建筑工作室联合创始人。', '王澍的实践强调历史记忆、地方材料与手工建造，反对脱离场所的形式消费。他在宁波博物馆、中国美术学院象山校区等项目中大量使用旧砖瓦、夯土意象和院落式空间，把江南建筑传统转化为当代建筑语言。'],
      ['中国当代建筑实践', '现代建筑师/事务所', '业余建筑工作室', 'Amateur Architecture Studio', '由王澍与陆文宇创立的杭州建筑工作室，关注地方建造、旧材料再利用与日常空间。', '“业余”并非反专业，而是强调保持对民间建造、地方经验和非标准化生活的敏感。其作品常以回收瓦片、厚重墙体、曲折院落和山水式路径回应快速城市化中的文化断裂。'],
      ['中国当代建筑实践', '现代建筑师/事务所', '张永和', 'Yung Ho Chang', '中国当代建筑师，非常建筑创始人，长期推动实验性建筑教育与实践。', '张永和的建筑关注观念、构造与日常生活之间的关系。他的实践从微型住宅、装置到城市建筑不等，常用清晰的构造逻辑和克制材料表达建筑的思想性。'],
      ['中国当代建筑实践', '现代建筑师/事务所', '非常建筑', 'Atelier FCJZ', '由张永和创立的建筑事务所，是中国当代实验建筑实践的重要代表。', '非常建筑的作品跨越建筑、家具、装置和展览，强调概念与建造之间的互相验证。它在中国当代建筑早期探索中具有开创性，帮助建立了建筑师独立实践的公共形象。'],
      ['中国当代建筑实践', '现代建筑师/事务所', '刘家琨', 'Liu Jiakun', '成都建筑师，2025年普利兹克建筑奖获得者，家琨建筑设计事务所创始人，关注普通建造、地方经验与社会记忆。', '刘家琨的作品常从西南地区日常材料和生活现场出发，在鹿野苑石刻博物馆、胡慧姗纪念馆、西村大院等项目中处理公共性、纪念性与城市生活之间的关系。'],
      ['中国当代建筑实践', '现代建筑师/事务所', '家琨建筑', 'Jiakun Architects', '刘家琨创立的建筑事务所，以地域性、社会性和材料实验著称。', '家琨建筑并不追求表面化的地方符号，而是从真实的建造条件、使用者经验和城市缝隙中寻找策略。其作品常呈现朴素、厚重、可被使用的公共气质。'],
      ['中国当代建筑实践', '现代建筑师/事务所', '马岩松', 'Ma Yansong', 'MAD建筑事务所创始人，代表了中国当代建筑中富有未来感和地景想象的一支。', '马岩松提出“山水城市”等概念，试图在高密度城市中重建人与自然的情感联系。其作品常以流动曲面、地景化屋顶和雕塑性形体塑造强烈的公共形象。'],
      ['中国当代建筑实践', '现代建筑师/事务所', 'MAD建筑事务所', 'MAD Architects', '由马岩松创立的国际化建筑事务所，以未来感、有机曲线和城市地景实践闻名。', 'MAD的项目强调建筑、自然与城市意象的融合，从住宅、文化建筑到城市综合体均尝试用连续曲面和公共步行空间弱化传统建筑体量的边界。'],
      ['中国当代建筑实践', '现代建筑师/事务所', 'OPEN建筑事务所', 'OPEN Architecture', '由李虎与黄文菁创立的建筑事务所，关注开放性、公共性与环境回应。', 'OPEN的作品重视空间的可进入性、教育性和公共生活潜力。上海油罐艺术中心、山谷音乐厅、清华海洋中心等项目体现了其在地景、结构与使用场景之间的综合思考。'],
      ['中国当代建筑实践', '现代建筑师/事务所', '朱锫', 'Zhu Pei', '中国当代建筑师，朱锫建筑事务所创始人，提出“自然建筑”相关实践方向。', '朱锫的作品常以地域气候、传统空间原型和材料质感为切入点，强调建筑在自然环境中的生成逻辑。景德镇御窑博物馆等项目展现了砖拱、窑址记忆与公共空间的转化。'],
      ['中国当代建筑实践', '现代建筑师/事务所', '标准营造', 'ZAO/standardarchitecture', '由张轲创立的建筑事务所，长期关注城市更新、微介入与高原地区建造。', '标准营造的实践从北京胡同更新到西藏地区建筑，强调精确的场地阅读和适度介入。其作品常在非常有限的空间中重组公共性、日常性和地方材料。'],
      ['中国当代建筑实践', '现代建筑师/事务所', '直向建筑', 'Vector Architects', '由董功创立的建筑事务所，重视场地、光线、材料和空间秩序。', '直向建筑的作品常以克制的几何和细腻构造回应地形与环境。海边图书馆、船厂1862改造等项目体现了其对场所氛围和建造质量的持续关注。'],
      ['中国当代建筑实践', '现代建筑师/事务所', '迹·建筑事务所', 'Trace Architecture Office', '由华黎创立的建筑事务所，关注材料、建造逻辑与地域环境之间的关系。', '迹·建筑事务所常在乡村、山地和文化建筑中探索低调而精确的空间介入，强调结构、材料和场地条件共同生成建筑，而不是把地域性处理为表面符号。'],
      ['中国当代建筑实践', '现代建筑师/事务所', '大舍建筑设计事务所', 'Atelier Deshaus', '由柳亦春、陈屹峰等创立的上海建筑事务所，关注城市文脉、公共建筑和空间秩序。', '大舍的作品多以清晰平面、克制体量和精确构造回应中国城市语境，强调建筑作为公共生活容器的稳定性与可读性。上海龙美术馆西岸馆等项目体现了其在既有结构与公共文化空间之间的组织能力。'],
      ['中国当代建筑实践', '代表项目', '宁波博物馆', 'Ningbo Museum', '王澍设计的文化建筑，以回收砖瓦墙面和山体般的体量回应地方历史。', '宁波博物馆通过“瓦爿墙”等做法把旧城拆迁中的材料重新纳入公共建筑，形成介于城墙、山体和博物馆之间的空间意象，是中国当代建筑中材料再利用和地方记忆表达的代表。'],
      ['中国当代建筑实践', '代表项目', '西村大院', 'West Village', '刘家琨设计的成都城市综合体，以开放街区与公共运动空间回应日常城市生活。', '西村大院通过大尺度围合体量、屋顶跑道、坡道和内院公共空间，把商业、运动、社区活动组织在一起，呈现一种介于街区、建筑和公共基础设施之间的复合形态。'],
      ['中国当代建筑实践', '代表项目', '海边图书馆', 'Seashore Library', '直向建筑设计的海边公共建筑，以面向海景的阅读空间和厚重墙体建立安静的场所感。', '海边图书馆以克制的体量、连续的窗洞和面向海面的阅读空间回应自然景观。它的价值不在夸张造型，而在空间节奏、光线控制与身体经验的细腻组织。'],
      ['中国当代建筑实践', '代表项目', '景德镇御窑博物馆', 'Imperial Kiln Museum', '朱锫设计的博物馆，以砖拱空间回应景德镇窑址历史与陶瓷文化。', '景德镇御窑博物馆将窑炉的拱形原型转化为连续展览空间，使用砖材、曲面拱券和半地下布局，使建筑既像遗址的一部分，也成为新的公共文化场所。'],
      ['中国当代建筑实践', '方法论', '材料再利用', 'Material Reuse', '在中国当代建筑实践中，将旧砖、旧瓦、拆除材料重新组织为新的空间表达和建造策略。', '材料再利用不仅是环保策略，也常承担地方记忆和城市更新的叙事功能。它要求建筑师理解材料尺度、施工工艺、结构安全与视觉秩序，而不是简单把旧材料作为表皮装饰。'],
      ['中国当代建筑实践', '方法论', '微更新', 'Micro Regeneration', '以小尺度、低干预和高适应性的方式改善既有城市空间。', '微更新强调对真实使用者、街巷关系和既有结构的细致阅读，常用于胡同、老社区、工业遗存和小型公共空间。它避免大拆大建，重视渐进式改善和公共生活的恢复。'],
 
      // Data added in previous turn. Keep this to avoid data loss.
    ];

export const CATEGORY_IMAGE_CONFIG: Record<string, { basePath: string; prefix?: string }> = {
