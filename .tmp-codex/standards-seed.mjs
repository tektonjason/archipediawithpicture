...
const jianbiaoku = (code) => `http://s.jianbiaoku.com/sou/?module=criterion&keyword=${encodeURIComponent(code)}`;
const soujianzhu = (code) => `https://www.soujianzhu.cn/NormAndRules/Default.aspx?key=${encodeURIComponent(code)}`;
